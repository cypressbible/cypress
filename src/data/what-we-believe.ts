...
export type OrdinancePair = { affirm: string; deny: string };
...
export const ordinancePhilosophy: OrdinanceTopic[] = [
  {
    id: "ord-purpose",
    heading: "Purpose",
    intro:
  ...
  },
  {
    ...
    pairs: [
      {
        affirm:
          "We affirm that in the act of communion, Christ is spiritually present with the believers in a unique and profound way. This presence is not physical but is real and vital to our growth in Christ (1 Cor 10:16-17).",
        deny:
          "We deny the doctrine of transubstantiation, which claims that the bread and wine become the literal body and blood of Christ. Such a view misinterprets the sacrament's nature and confuses the elements' symbolic and spiritual significance (Matt 26:26-28, John 6:63)."
      }
    ]
  },
  {
    ...
    pairs: [
      {
        affirm:
          "We affirm that the bread and the cup are symbols representing the body and blood of Christ, given as a sacrifice for our sins. These elements are outward signs of an inward grace (Luke 22:19-20) of the believer.",
        deny:
          "We deny communion has inherent power to confer grace or salvation. Communion is a means of grace as it strengthens faith and encourages spiritual growth, but it is not efficacious in and of itself (Eph 2:8-9)."
      }
    ]
  },
  {
    ...
    pairs: [
      {
        affirm:
          "We affirm that communion is a memorial act commanded by Christ and is open to all followers of Christ. Through it, we remember His death, celebrate His resurrection, and anticipate His return (1 Cor 11:24-26). The elders are responsible for withholding communion from those under active church discipline.",
        deny:
          "We deny the practice of restricting communion to a particular denomination or group of believers. While local church membership and doctrinal alignment are important, the table is open to all who have confessed faith in Christ and are in right standing with Him (Rom 15:7, Gal 3:28)."
      }
    ]
  },
  {
    ...
    pairs: [
      {
        affirm:
          "We affirm that communion signifies our unity as the body of Christ. It is an act of fellowship and mutual edification, reinforcing our commitment to one another in Christ (1 Cor 10:17).",
        deny:
          "We deny any approach to communion that treats it as an individual act. Such a view undermines the privilege of the ordinance and the common unity we have in Christ (1 Cor 11:27-29)."
      }
    ]
  },
  {
    id: "ord-examination",
    heading: "Personal examination",
    pairs: [
      {
        affirm:
          "We affirm the importance of self-examination before participating in communion. Believers are called to reflect on their relationship with God and others, confessing sin and seeking reconciliation where necessary (1 Cor 11:28-31). Heads of households are responsible for determining when it is appropriate for their children to be baptized and take communion. We encourage parents to teach their children the link between salvation, baptism, and communion.",
        deny:
          "We deny the appropriateness of partaking in communion without personal reflection and repentance. Communion is not for unbelievers or children who have not yet come to trust Christ as Lord. Participation in an unworthy manner can lead to spiritual (or physical) harm and dishonors the Lord's Supper (1 Cor 11:27-30)."
      }
    ]
  },
  {
    id: "ord-assembly",
    heading: "Assembled church and elder oversight",
    pairs: [
      {
        affirm:
          "We affirm that communion should be celebrated in the context of the assembled church as a visible symbol of our corporate unity and overseen by elders who ensure that it is conducted in a manner consistent with biblical teaching and church order (1 Cor 11:18, 1 Tim 3:1-7).",
        deny:
          "We deny that communion should be taken individually or outside the church gathering overseen by the church elders. Taking communion in the full gathered context values the leadership role of the elders, strengthens the local community, and ensures the doctrinal integrity of the ordinance (Heb 13:17, Acts 14:23)."
      }
    ]
  },
  {
